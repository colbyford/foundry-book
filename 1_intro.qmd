...
- Under the **Agent service** section, click the **+ Select Resources** button and create a new Cosmos DB database, AI Search service, and Storage Account. For the AI Search service, be sure to select the *Basic* pricing tier.
