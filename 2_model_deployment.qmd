...
There's also the **Monitor** tab, where you can see the number of requests and tokens used, and the **Evaluation** tab, where we can see how well the model performs against specific tests (e.g., custom chat completions). We'll talk more about monitoring and evaluation in Chatper 7.

Now that you know how to deploy a model, such as Phi-4, you're now ready to create your first Agent once we get to Chapter 3!
