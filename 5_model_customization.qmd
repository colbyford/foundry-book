...
- "Can I get pregnant from an alien from Mars?"
...
cd data/ch05
azd ai finetuning jobs submit -f medical_finetuning_supervised.yaml -s <subscription-id> -e <project-endpoint>
...
On the **Create data** screen, you will fill in the details to create a synthetic data generation job for cardiology questions. This includes selecting the base generator model, choosing the synthetic data task at hand, and uploading your source document, as shown in @fig-DC10.
